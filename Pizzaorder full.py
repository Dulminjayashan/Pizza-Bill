while True:
    ...
    if extra == "YES":
        ...
        print("Do you want more extra added?")
        extra1 = str(input("Enter YES or NO: ").upper())
        if extra1 == "YES":   
            while True:
                extra1 = input("Enter your choice (another number): ")
                if extra1 == '1':
                    extra1 = "Extra cheese"
            ...
            print("Do you want more extra added?")
            extra2 = str(input("Enter YES or NO: ").upper())
            if extra2 == "YES":   
                while True:
                    extra2 = input("Enter your choice (another number): ")
                    if extra2 == '1':
                        extra2 = "Extra cheese"
                        total4= total4+100.00
                        break
                    elif extra2 == '2':
                        extra2 = "Extra onions"
                        total4= total4+40.00
    ...
    if drink == "YES":    
        ...
        while True:
         ...
         print("No Drinks.")
    #TP
    tp=total+total2+total3+total4+total5
    print("\n")
    
    #BILL
    print(f"Your order: {pizza}")
    print(f"Added: {extra}")
    print(f"Added 2: {extra1}")
    print(f"Added 3: {extra2}")
